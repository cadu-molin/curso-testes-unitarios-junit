...
class CalculadoraGanhosTest {
    ...
    @BeforeEach
    void beforeEach() {
        autor = new Editor(1L, "Carlos", "carlos@gmial.com", new BigDecimal(20), true);

        post = new Post(1L, "Ecossistema Java",
                "O ecossistema do Java é muito maduro", autor,
    ...
    public void Dado_um_post_e_autor_premium_Quando_calcular_ganhos_Entao_deve_retornar_valor_com_bonus() {
        ...
        assertEquals(new BigDecimal(150), ganhos.getTotalGanho());
    }
    ...
    public void Dado_um_post_e_autor_nao_premium_Quando_calcular_ganhos_Entao_deve_retornar_valor_sem_bonus() {
        ...
        assertEquals(new BigDecimal(140), ganhos.getTotalGanho());
    }
}